...
const routes = [
  ...
  { folder: 'Músicas', name: 'Detalhe da música', method: 'GET', path: '/songs/{{songId}}', status: PLANEJADO },
  {
    folder: 'Músicas',
  ...
  { folder: 'Edição', name: 'Remix com outro estilo', method: 'POST', path: '/songs/{{songId}}/remix', status: PLANEJADO, body: { styles: 'versão acústica, violão e voz' } },
  { folder: 'Edição', name: 'Substituir um trecho', method: 'POST', path: '/songs/{{songId}}/replace-section', status: PLANEJADO, body: { startMs: 30000, endMs: 45000, styles: 'solo de guitarra' } },
  {
    folder: 'Edição',
    name: 'Edições sem IA',
    method: 'POST',
  ...
  { folder: 'Edição', name: 'Gerar capa', method: 'POST', path: '/songs/{{songId}}/cover-art', status: PLANEJADO, body: { prompt: 'estrada ao entardecer, estética retrô' } },

  // --------------------------------------------------------- Workspaces
  { folder: 'Biblioteca', name: 'Listar workspaces', method: 'GET', path: '/workspaces', status: PLANEJADO },
  { folder: 'Biblioteca', name: 'Criar workspace', method: 'POST', path: '/workspaces', status: PLANEJADO, body: { name: 'Nocturne.sh' } },
  { folder: 'Biblioteca', name: 'Renomear workspace', method: 'PATCH', path: '/workspaces/{{workspaceId}}', status: PLANEJADO, body: { name: 'Novo nome' } },
  { folder: 'Biblioteca', name: 'Listar playlists', method: 'GET', path: '/playlists', status: PLANEJADO },
  { folder: 'Biblioteca', name: 'Criar playlist', method: 'POST', path: '/playlists', status: PLANEJADO, body: { name: 'Madrugada', isPublic: false } },
  { folder: 'Biblioteca', name: 'Adicionar música à playlist', method: 'POST', path: '/playlists/{{playlistId}}/songs', status: PLANEJADO, body: { songId: '{{songId}}' } },
  { folder: 'Biblioteca', name: 'Estilos salvos', method: 'GET', path: '/styles', status: PLANEJADO },

  // ------------------------------------------------------------- Social
  { folder: 'Social', name: 'Explore', method: 'GET', path: '/explore', query: { tab: 'trending' }, status: PLANEJADO, auth: false },
  { folder: 'Social', name: 'Perfil público', method: 'GET', path: '/users/{{handle}}', status: PLANEJADO, auth: false },
  { folder: 'Social', name: 'Curtir', method: 'POST', path: '/songs/{{songId}}/like', status: PLANEJADO },
  { folder: 'Social', name: 'Comentários', method: 'GET', path: '/songs/{{songId}}/comments', status: PLANEJADO, auth: false },
  { folder: 'Social', name: 'Comentar', method: 'POST', path: '/songs/{{songId}}/comments', status: PLANEJADO, body: { body: 'Muito boa!', timestampMs: 42000 } },
  { folder: 'Social', name: 'Seguir criador', method: 'POST', path: '/users/{{handle}}/follow', status: PLANEJADO },
  {
    folder: 'Social',
  ...
  { folder: 'Créditos e cobrança', name: 'Planos e pacotes', method: 'GET', path: '/plans', status: PLANEJADO, auth: false },
  { folder: 'Créditos e cobrança', name: 'Assinar um plano', method: 'POST', path: '/billing/subscribe', status: PLANEJADO, body: { planCode: 'pro', method: 'pix' } },
  { folder: 'Créditos e cobrança', name: 'Comprar pacote avulso', method: 'POST', path: '/billing/packs/pack_1500/purchase', status: PLANEJADO, body: { method: 'pix' } },
  {
    folder: 'Créditos e cobrança',
